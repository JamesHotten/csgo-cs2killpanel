    ...
    public sealed partial class KillConfirmWidgetPage
    {
        ...
        private async Task SyncCrossfireGameplaySettingsAsync()
        {
            ...
            if (_crossfireAdvancedEffectsPanel != null)
            {
                ...
                settings.HeadshotSpecialAudioPriority = _crossfireAdvancedEffectsPanel.GetHeadshotSpecialAudioPriority(settings.HeadshotSpecialAudioPriority);
                settings.KnifeSpecialAudioPriority = _crossfireAdvancedEffectsPanel.GetKnifeSpecialAudioPriority(settings.KnifeSpecialAudioPriority);
                settings.HeadshotSpecialIconPriority = _crossfireAdvancedEffectsPanel.GetHeadshotSpecialIconPriority(settings.HeadshotSpecialIconPriority);
                settings.KnifeSpecialIconPriority = _crossfireAdvancedEffectsPanel.GetKnifeSpecialIconPriority(settings.KnifeSpecialIconPriority);
                ...
                settings.LastKillSpecialAudio = _crossfireAdvancedEffectsPanel.GetLastKillSpecialAudio(
                    settings.LastKillSpecialAudio);
                settings.AssistAudioEnabled = _crossfireAdvancedEffectsPanel.GetAssistAudioEnabled(settings.AssistAudioEnabled);
            }
