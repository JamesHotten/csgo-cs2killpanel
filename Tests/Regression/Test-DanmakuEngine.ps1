...
'PASS: all 16 large source-derived event pool files contain at least 1000 validated entries; every event owns fresh reaction history; each event has two burst and three aftermath messages with a hard nine-item display cap; rendered text is single-line.'
