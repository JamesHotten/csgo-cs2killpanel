...
pub struct AppState {
    ...
    pub spectated_player_effects_enabled: AtomicBool,
...
mod tests {
    use super::{
        CrossfireStreakMode, EventSoundMode, EventSoundRoute, EventSoundSettings,
    ...
    #[test]
    fn event_sound_routes_use_assist_then_headshot_then_knife_priority() {
        let settings = EventSoundSettings {
            ...
            knife: EventSoundRoute {
                ...
                custom_path: Some("knife.wav".into()),
            },
            assist: EventSoundRoute {
                mode: EventSoundMode::Custom,
                custom_path: Some("assist.wav".into()),
            },
            ..Default::default()
        };
        assert_eq!(
        ...
        assert_eq!(
            settings.route_for(true, true, false).mode,
            EventSoundMode::Common
        );
        assert_eq!(
            settings
                .route_for(false, true, false)
                .custom_path
                .as_deref(),
            Some("knife.wav")
        );
